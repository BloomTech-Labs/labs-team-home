...
describe("DropdownToggle", () => {
  ...
  it("should add default sr-only content", () => {
    const wrapper = mount(<DropdownToggle />, {
      context: { isOpen, inNavbar, toggle, popperManager },
      childContextTypes: { popperManager }
    });
  ...
  it("should add default sr-only content", () => {
    const wrapper = mount(<DropdownToggle aria-label="Dropup Toggle" />, {
      context: { isOpen, inNavbar, toggle, popperManager },
      childContextTypes: { popperManager }
    });
  ...
  it("should render elements", () => {
    const wrapper = mount(<DropdownToggle>Click Me</DropdownToggle>, {
      context: { isOpen, inNavbar, toggle, popperManager },
      childContextTypes: { popperManager }
    });
  ...
  describe("color", () => {
    ...
    it("should render the dropdown as a BUTTON element with explicit color success", () => {
      const wrapper = mount(<DropdownToggle color="success" />, {
        context: { isOpen, inNavbar, toggle, popperManager },
        childContextTypes: { popperManager }
      });
    ...
    it("should render the dropdown as an A element with no color attribute", () => {
      const wrapper = mount(<DropdownToggle tag="a" />, {
        context: { isOpen, inNavbar, toggle, popperManager },
        childContextTypes: { popperManager }
      });
    ...
    it("should render the dropdown as a DIV element with no color attribute", () => {
      const wrapper = mount(<DropdownToggle tag="div" color="success" />, {
        context: { isOpen, inNavbar, toggle, popperManager },
        childContextTypes: { popperManager }
      });
  ...
  it("should render a split", () => {
    const wrapper = mount(<DropdownToggle split>Ello world</DropdownToggle>, {
      context: { isOpen, inNavbar, toggle, popperManager },
      childContextTypes: { popperManager }
    });
  ...
  describe("nav", () => {
    it("should add .nav-link class", () => {
      const wrapper = mount(<DropdownToggle nav>Ello world</DropdownToggle>, {
        context: { isOpen, inNavbar, toggle, popperManager },
        childContextTypes: { popperManager }
      });
