...
describe("InputGroupButton", () => {
  it("should render InputGroupAddon", () => {
    const wrapper = shallow(
      <InputGroupButton addonType="append">Yo!</InputGroupButton>
    );
  ...
  describe("Shorthand usage", () => {
    ...
    it("should render additional props on the child Button", () => {
      const wrapper = shallow(
        <InputGroupButton addonType="append" color="rad">
          Yo!
        </InputGroupButton>
      );
    ...
    it("should render additional classes on the child Button", () => {
      const wrapper = shallow(
        <InputGroupButton addonType="append" className="yo">
          Yo!
        </InputGroupButton>
      );
    ...
    it("should render groupClassName as additional classes on the input-group-btn wrapper", () => {
      const wrapper = shallow(
        <InputGroupButton addonType="append" groupClassName="other">
          Yo!
        </InputGroupButton>
      );
