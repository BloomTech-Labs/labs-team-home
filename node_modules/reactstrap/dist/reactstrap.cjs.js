    ...
    if (isobject(columnProp)) {
      ...
      colClasses.push(
        mapToCssModules(
          classNames(
            ((_classNames = {}),
            (_classNames[colClass] = columnProp.size || columnProp.size === ""),
...
var defaultProps$i = _extends(
  {},
  reactTransitionGroup.Transition.defaultProps,
  {
    tag: "div",
    baseClass: "fade",
...
CarouselItem.propTypes = _extends(
  {},
  reactTransitionGroup.Transition.propTypes,
  {
    tag: tagPropType,
    in: PropTypes.bool,
    cssModule: PropTypes.object,
