  ...
  (function(_React$Component) {
    ...
    _proto.handleKeyDown = function handleKeyDown(e) {
      ...
      if (this.props.isOpen && e.target.getAttribute("role") === "menuitem") {
        if ([_utils.keyCodes.tab, _utils.keyCodes.esc].indexOf(e.which) > -1) {
          ...
          [_utils.keyCodes.space, _utils.keyCodes.enter].indexOf(e.which) > -1
        ) {
          e.target.click();
          this.getMenuCtrl().focus();
        } else if (
          [_utils.keyCodes.down, _utils.keyCodes.up].indexOf(e.which) > -1 ||
          ([_utils.keyCodes.n, _utils.keyCodes.p].indexOf(e.which) > -1 &&
            e.ctrlKey)
        ) {
          ...
          if (
            _utils.keyCodes.up === e.which ||
            (_utils.keyCodes.p === e.which && e.ctrlKey)
          ) {
            index = index !== 0 ? index - 1 : $menuitems.length - 1;
          } else if (
            _utils.keyCodes.down === e.which ||
            (_utils.keyCodes.n === e.which && e.ctrlKey)
          ) {
    ...
    _proto.render = function render() {
      ...
      var _omit = (0, _utils.omit)(this.props, [
        ...
        attrs = (0, _objectWithoutPropertiesLoose2.default)(_omit, [
          "className",
          "cssModule",
          "dropup",
          "isOpen",
