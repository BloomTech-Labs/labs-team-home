...
describe("InputGroupAddon", () => {
  it('should render with "div" tag', () => {
    const wrapper = shallow(
      <InputGroupAddon addonType="append">Yo!</InputGroupAddon>
    );
  ...
  it('should render with "input-group-*" classes', () => {
    const wrapperPrepend = shallow(
      <InputGroupAddon addonType="prepend">Yo!</InputGroupAddon>
    );
    const wrapperAppend = shallow(
      <InputGroupAddon addonType="append">Yo!</InputGroupAddon>
    );
  ...
  it("should render additional classes", () => {
    const wrapper = shallow(
      <InputGroupAddon addonType="append" className="other">
        Yo!
      </InputGroupAddon>
    );
  ...
  it("should render custom tag", () => {
    const wrapper = shallow(
      <InputGroupAddon addonType="append" tag="main">
        Yo!
      </InputGroupAddon>
    );
