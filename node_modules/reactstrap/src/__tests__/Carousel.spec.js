      ...
      it("should add the appropriate classes when entering right", () => {
        ...
        expect(
          wrapper
            ...
            .find("div")
            .prop("className")
        ).toEqual("carousel-item carousel-item-left carousel-item-next");
        ...
        expect(
          wrapper
            ...
            .find("div")
            .prop("className")
        ).toEqual("carousel-item active carousel-item-left");
        jest.runTimersToTime(600);
        expect(
          wrapper
            .update()
      ...
      it("should add the appropriate classes when entering left", () => {
        ...
        expect(
          wrapper
            ...
            .find("div")
            .prop("className")
        ).toEqual("carousel-item carousel-item-right carousel-item-prev");
        jest.runTimersToTime(600);
        expect(
          wrapper
            .update()
        ...
        expect(
          wrapper
            ...
            .find("div")
            .prop("className")
        ).toEqual("carousel-item active carousel-item-right");
        jest.runTimersToTime(600);
        expect(
          wrapper
            .update()
